...
const students = [
  { id: 1, name: "Thabo Nkosi", age: 24, course: "Backend Engineering" },
  { id: 2, name: "Amara Diallo", age: 22, course: "Frontend Development" },
  { id: 3, name: "Sipho Dlamini", age: 26, course: "Full Stack Development" },
  { id: 4, name: "Fatima Malik", age: 23, course: "Backend Engineering" },
];
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === "GET" && req.url === "/") {
    return sendJSON(200, {
      ...
      version: "1.0",
      author: "Mohammad Shehabul Islam",
    });
  }

  /* GET /about - course details */
